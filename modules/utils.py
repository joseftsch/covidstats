        ...
        for row in reader:
            if today in row["Datum"]:
                if row["Name"] in bundeslaender:
                    ...
                    covid_data[row["Name"]]['Gu15_1'] = str(int(row["Gruppe_<15_M_1"])+int(row["Gruppe_<15_W_1"])+int(row["Gruppe_<15_D_1"]))
                    covid_data[row["Name"]]['Gu15_2'] = str(int(row["Gruppe_<15_M_2"])+int(row["Gruppe_<15_W_2"])+int(row["Gruppe_<15_D_2"]))
                    covid_data[row["Name"]]['G15-24_1'] = str(int(row["Gruppe_15-24_M_1"])+int(row["Gruppe_15-24_W_1"])+int(row["Gruppe_15-24_D_1"]))
                    covid_data[row["Name"]]['G15-24_2'] = str(int(row["Gruppe_15-24_M_2"])+int(row["Gruppe_15-24_W_2"])+int(row["Gruppe_15-24_D_2"]))
                    ...
                    covid_data[row["Name"]]['ImpfstoffNichtZugeordnet_1'] = row["ImpfstoffNichtZugeordnet_1"]
                    covid_data[row["Name"]]['ImpfstoffNichtZugeordnet_2'] = row["ImpfstoffNichtZugeordnet_2"]
                    covid_data[row["Name"]]['ImpfstoffNichtZugeordnet_G'] = str(int(row["ImpfstoffNichtZugeordnet_1"])+int(row["ImpfstoffNichtZugeordnet_2"]))
